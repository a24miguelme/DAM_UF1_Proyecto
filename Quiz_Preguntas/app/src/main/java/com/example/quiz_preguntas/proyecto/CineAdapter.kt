...
class CineAdapter(private val listaPreguntas: List<Pregunta>) : RecyclerView.Adapter<CineAdapter.PreguntaViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PreguntaViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_pregunta_cine, parent, false)
    ...
    class PreguntaViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val preguntaTextView: TextView = itemView.findViewById(R.id.textPregunta2)
